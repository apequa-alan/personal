...
const methodLinks = [
  ...
  {
    title: "Трансляция педагогического опыта",
    link: "/methods/experience-translation",
  },
  {
    title: "Сценарии утренников и праздников",
    link: "/methods/entertainment-scripts",
  },
];
...
export default {
  ...
  setup() {
    const startDate = new Date("2023.02.18");
    const now = new Date();
